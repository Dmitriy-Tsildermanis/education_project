...
from tests.constants import INVALID_TYPE_CASES_WITHOUT_LIST, VALID_BUT_EMPTY_RETERN, INVALID_TYPE_CASES
...
def test_card_number_generator_edge_case():
    assert list(card_number_generator(999999999999995, 999999999999999)) == ['0999 9999 9999 9995',
                                                                             '0999 9999 9999 9996',
                                                                             '0999 9999 9999 9997',
                                                                             '0999 9999 9999 9998',
                                                                             '0999 9999 9999 9999']
...
def test_card_number_generator_start_is_greater():
    assert list(card_number_generator(5, 1)) == ['0000 0000 0000 0001',
                                                 '0000 0000 0000 0002',
                                                 '0000 0000 0000 0003',
                                                 '0000 0000 0000 0004',
                                                 '0000 0000 0000 0005']
